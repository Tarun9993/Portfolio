...
const Skills = () => {
    return (
        ...
        <div>
            ...
            <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-6 py-1 text-xl font-bold text-white backdrop-blur-3xl tracking-wide">
              Technologies
            </span>
          </button>
            </div>
