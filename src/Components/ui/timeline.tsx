...
//   return (
//     (<div
//       className="w-full bg-black dark:bg-neutral-950 font-sans md:px-90 px-40 py-10"
//       ref={containerRef}>
...
//           </button>
//       </div>
//       <div ref={ref} className="relative max-w-7xl mx-auto pb-20 py-10">
//         {data.map((item, index) => (
//           <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10 gap-15">
//             <div
//               className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
//               <div
//                 className="h-8 absolute left-3 md:left-3 w-8 rounded-full bg-white dark:bg-black flex items-center justify-center ml-1" >
//                 <div
...
//               <h3
//                 className="md:hidden block text-2xl mb-1 text-left font-bold text-neutral-500 dark:text-neutral-500">
//                 {item.title}
//               </h3>
//               {item.content}{" "}
//             </div>
