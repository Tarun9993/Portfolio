    ...
    (<div
     ...
     <div className="md:flex lg:gap-10 z-50 lg:px-50  md:px-28 md:py-50 py-10 lg:py-50">
        ...
        <h1 className="text-white font-semi-bold text-3xl tracking-wide sm:pt-18 sm:px-32 md:px-0 md:pt-0 pt-20 sm:p-0 p-7 w-full px-10">Hi, Myself     
          ...
          <div>
            <h1 className="text-white font-medium tracking-wide text-2xl sm:px-40 sm:pt-10 sm:text-2xl md:pt-6 md:px-0 pt-5 pl-10 px-5 leading-10 w-full">I'M A Web developer </h1>
          </div>
          <div>
