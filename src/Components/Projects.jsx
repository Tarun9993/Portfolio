  ...
  return (
    <div className="pb-30">
      ...
      <div className="md:flex lg:px-80 justify-between lg:gap-20  pb-25 px-6 sm:px-50 md:px-20 md:gap-4">
        <div className="">
            <div className="h-[280px] w-[350px] bg-[#080808db] rounded-2xl">
